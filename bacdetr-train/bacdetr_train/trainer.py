...
import bacdetr_train.util.misc as utils
from bacdetr_train.datasets import build_dataset, get_coco_api_from_dataset
from bacdetr_train.engine import evaluate, train_one_epoch
from bacdetr.models import build_model, build_criterion_and_postprocessors, PostProcess
from bacdetr_train.util.benchmark import benchmark
from bacdetr_train.util.drop_scheduler import drop_scheduler
from bacdetr.util.files import download_file
from bacdetr_train.util.get_param_dicts import get_param_dict
from bacdetr_train.util.utils import ModelEma, BestMetricHolder, clean_state_dict
...
class Model:
    def __init__(self, **kwargs):
        ...
        if args.pretrain_weights is not None:
            ...
            if args.pretrain_keys_modify_to_load is not None:
                from bacdetr_train.util.obj365_to_coco_model import get_coco_pretrain_from_obj365
    ...
    def export(self, output_dir="output", infer_dir=None, simplify=False,  backbone_only=False, opset_version=17, verbose=True, force=False, shape=None, batch_size=1, **kwargs):
        ...
        try:
            from bacdetr_train.deploy.export import export_onnx, onnx_simplify, make_infer_image
        except ImportError:
